...
#[derive(Debug)]
pub struct DataBridgeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl DataBridgeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting DataBridge processing");
    
    let mut processor = DataBridgeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = DataBridgeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = DataBridgeProcessor::new(false);
